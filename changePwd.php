                    ...
                    <div class="checkout_info mb-20">
						<?php
							if(!isset($_SESSION['isCheck'])){
								echo "<script>alert('请通过邮箱验证!');</script>";
								echo "<script>location.href='findPwd.php';</script>";
								}
						?>
                        <form class="form-row" method="post" action="checkUser.php">
                            <h1 class="last-title mb-30 text-center">请输入您的新密码</h1>
                            <div class="form_group col-12">
                                <label class="form-label">用户名<span>*</span></label>
                                <input class="input-form" type="text" name="username" id="username" value='<?php if(isset($_SESSION['username'])){echo $_SESSION['username'];}?>' readonly />
                            </div>
							<div class="form_group col-12">
							    <label class="form-label">新密码<span>*</span></label>
							    <input class="input-form" type="password" name="newpwd" id="newpwd" required />
							</div>
                            <div class="form_group group_3 col-lg-3">
                                <button class="login-register" name="changepwd" type="submit">提交</button>
                            </div>
