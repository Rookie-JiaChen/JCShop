                ...
                <div class="offset-lg-3 col-lg-6">
                    <div class="checkout_info mb-20">
                        <form class="form-row" method="post" action="checkUser.php">
                            <h1 class="last-title mb-30 text-center">请输入邮箱验证码</h1>
                            <div class="form_group col-12">
                                <label class="form-label">用户名<span>*</span></label>
								
                                <input class="input-form" type="text" name="username" value='<?php if(isset($_SESSION['username'])){echo $_SESSION['username'];}?>'  readonly />
                            </div>
							<div class="form_group col-12">
							    <label class="form-label">电子邮箱<span>*</span></label>
							    <input class="input-form" type="text" name="email" value='<?php if(isset($_SESSION['email'])){echo $_SESSION['email'];}?>'  readonly />
							</div>
							<div class="form_group col-12">
							    <label class="form-label">验证码<span>*</span></label>
							    <input class="input-form" style="width: 60%;" type="text" name="code" required />
								<button class="btn btn-primary" type="button" onclick="sendmail();">点击发送验证码</button>
							</div>
                            <div class="form_group group_3 col-lg-3">
                                <button class="login-register" name="checkcode" type="submit">提交</button>
                            </div>
