            ...
            <div class="row">
                <div class="offset-lg-3 col-lg-6">
                    <div class="checkout_info mb-20">
                        <form class="form-row" method="post" action="checkLogin.php">
                            <h1 class="last-title mb-30 text-center">登录你的帐号</h1>
                            ...
                            <div class="form_group group_3 col-lg-3">
                                <button class="login-register" name="logining" type="submit">登录</button>
                            </div>
                            <div class="form_group group_3 col-lg-9">
                                
                            </div>
                            <div class="col-lg-12 text-left">
                                <a class="lost-password" href="forgetPwd.php">忘记密码?</a>
                            </div>
                            <div class="col-lg-12 text-left">
                                <p class="register-page"> 没有帐号? <a href="register.php">注册一个吧</a>.</p>
                            </div>
                        </form>
                    </div>
                </div>
