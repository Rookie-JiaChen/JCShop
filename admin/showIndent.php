...
<?php include "../include/jc_indent.php";//引入数据库访问层方法?>
<body>
<div id="wrapper">
     <!-- Navigation -->
 ...
 <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
 				<div class="panel-body no-padding">
					...
					<form action="delAllIndents.php" method="post">
 						<tbody>
							<?php
							$size=10;//定义每页显示的记录数
							$rs = findAllIndent();//调用数据库访问层方法
							...
							$rs = findIndentLimit($start,$size);//调用数据库访问层方法
							foreach($rs as $key => $value){//循环遍历数组，再跟据数据库列名来打印出数据
							?>
 							<tr>
 								<td><input type="checkbox" name="<?php echo $value['orderid'];?>" value="<?php echo $value['orderid'];?>"></td>
								...
								<td><a class=" btn btn-warning" href="observeIndent.php?mid=<?php echo $value['orderid'];?>">查看</a>&nbsp;<a class="btn btn-danger" href= "delIndent.php?id=<?php echo $value['orderid'];?>">删除</a></td>
 							</tr>
 						<?php
 							}
 						}
						...
						?>
								...
								<td></td>
								<td>
									<input class="btn btn-primary" type="submit" value="删除所选订单" class="buttoncss" style="float:left; margin-right:80px;" />
									</form>
								</td>
								<td>
									<?php
